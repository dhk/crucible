...
// commit: the git SHA of the PR merged for this cycle (links to full diff + rationale).
const CYCLES = [
  { id: 1,  agent: 'strawman',    title: 'Seed: pose the problem',           rationale: 'Establish that the debate itself is the artifact. Set dark-mode-first tone.', added: ['C01','C10','C15'], removed: [],     mutated: [], at: '2026-04-18', branch: 'main',         commit: 'a3f1c2d' },
  { id: 2,  agent: 'steelman',    title: 'Lineage as the load-bearing wall', rationale: 'Without concept lineage, replay is shallow. Promote lineage to core. Introduce registry.', added: ['C02','C05','C23','C24'], removed: [], mutated: ['C01'], at: '2026-04-20', branch: 'main',         commit: 'b8e04f1' },
  { id: 3,  agent: 'strawman',    title: 'Scrub the river',                  rationale: 'Replayability deserves first-class status. Propose tree metaphor.', added: ['C03','C06','C12','C16'], removed: [], mutated: ['C02'], at: '2026-04-23', branch: 'main',         commit: 'c71a9b3' },
  { id: 4,  agent: 'steelman',    title: 'Argument-shaped, not just graph-shaped', rationale: 'Argument graphs handle support/contradict natively. Make mutations explain themselves.', added: ['C04','C08','C11','C17'], removed: [], mutated: ['C05'], at: '2026-04-26', branch: 'main',         commit: 'd55e2c8' },
  { id: 5,  agent: 'strawman',    title: 'Geology + ghosts',                 rationale: 'Walls as strata; abandoned ideas as ghost nodes. Neural metaphor proposed and tabled.', added: ['C07','C09','C22'], removed: [], mutated: ['C08'], at: '2026-04-29', branch: 'metaphor-fork', commit: 'e2f7a0d' },
  { id: 6,  agent: 'strawman',    title: 'Islands and fossils get a home',   rationale: 'Promote islands + dead ends to dedicated views. Archaeological framing.', added: ['C13','C14'], removed: [], mutated: ['C09'], at: '2026-05-02', branch: 'main',         commit: 'f9c3b5e' },
  { id: 7,  agent: 'adversarial', title: 'Does the graph break at 1000?',    rationale: 'Force layout assumes ~50 concepts. At a population of orgs, this collapses.', added: ['C18'], removed: [], mutated: ['C05','C06'], at: '2026-05-06', branch: 'main',         commit: '1a4d8f2' },
  { id: 8,  agent: 'adversarial', title: 'Identity across repos',            rationale: 'Same concept renamed across two repos — is it the same concept? Open.', added: ['C19'], removed: [], mutated: [], at: '2026-05-09', branch: 'risk-branch',  commit: '2b6e0c7' },
  { id: 9,  agent: 'adversarial', title: 'Arbitration vs. honest signal',    rationale: 'Auto-resolving deadlocks hides resistance. Propose convergence prediction as alternative.', added: ['C20','C21'], removed: [], mutated: [], at: '2026-05-12', branch: 'risk-branch',  commit: '3c9f1a4' },
  { id: 10, agent: 'steelman',    title: 'Resurrect live debate',            rationale: 'Live multi-agent debate previously failed on cost. With bounded scoping it returns.', added: [], removed: [], mutated: ['C22'], at: '2026-05-16', branch: 'main',         commit: '4d2b7e9' },
  { id: 11, agent: 'adversarial', title: 'Probe the neural metaphor',        rationale: 'Synaptic visuals look good but don\'t add semantic information. Demote to ambient effect.', added: [], removed: [], mutated: ['C09','C17'], at: '2026-05-19', branch: 'main',         commit: '5e8c3d1' },
  { id: 12, agent: 'steelman',    title: 'Tighten the spine',                rationale: 'Codify lineage→replay→explainability as the load-bearing chain.', added: [], removed: [], mutated: ['C01','C02','C03','C04'], at: '2026-05-22', branch: 'main',         commit: '6f0a5b8' },
];
